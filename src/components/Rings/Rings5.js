...
let ogHero = localStorage.getItem('portrait') 
	...
	function tullyChallenge() { 
		...
		setTimeout(() => {  window.location.href = 'https://www.na-ring-gael.com/pucaloic2'; }, 2000);
...
:null
			...
			<div className="grid-item" id="toggle-glass-btn2">
            <img 
                src={isOn ? pearl : emerald} 
                id="glass-btn-img" 
                alt="a crystal or precious stone toggle on off button" 
                onClick={handleClick} 
            />
        </div>
