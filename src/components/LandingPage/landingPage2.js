...
import ChampionSelect2 from '../IntroSequence/ChampionSelect2';
...
const LandingPage = () => {
  ...
  const championSelect = new ChampionSelect2()//ChampionSelect2(scene, x, y);
//   useEffect(() => {
//     if (!scene) return; // Ensure scene exists before creating the object
//     const championSelect = new ChampionSelect2();
//     scene.add.existing(championSelect);
//   }, [scene]);
