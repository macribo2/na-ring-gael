    ...
    useEffect(() => {
        const initializeGame = () => {
            const config = {
                ...
                scene: [GameScene, NavCD], // Add NavCD to the scene list
...
featherIcon.on('pointerdown', () => {
    ...
    this.bally0map = this.add.sprite(-200, 100, 'genericMap0').setOrigin(0).setAlpha(0.3);

    const bally0mapScale = 2
...
export default GenericLocations;
